...
```{r}
#| label: fig-1
#| fig-cap: Levels of real disposable income, in billions of dollars, chained to 2017 prices
#| echo: false
#| warning: false
#| message: false
...
```{r}
#| label: fig-2
#| fig-cap: Levels of real consumption expenditure, in billions of dollars, chained to 2017 prices
#| echo: false
#| warning: false
#| message: false
...
```{r}
#| label: tbl-1
#| tbl-cap: "Description of cleaned data"
#| warning: false
#| message: false
#| echo: false
...
table1 <-
  tibble(
    "Variable"= c("Date", "Durable goods", "Non-durable goods", "Food", "Disposable income",
                      "Healthcare", "Services"),
    "Description" = c("Date of data collected",
                      "Real expenditure in durable goods",
                      "Real expenditure in non-durable goods",
                      "Real food expenditure",
                      "Real disposable income",
                      "Real expenditure in healthcare",
                      "Real expenditure in services")
  )
...
newnames <- c("durable_expenditure" = "Durable goods",
              ...
              "healthcare_expenditure" = "Halthcare",
...
#| fig-subcap: ["Posterior prediction check of first model", "Posterior prediction check of second model"]
