---
title: "You have more money in your wallet. This does not mean you will spend extra on food"
subtitle: "Examining the relationship between disposable income and food expenditure for American consumers"
author: Ahnaf Alam
...
We gathered our data from Federal Reserve Economic Data (FRED), an extensive online database housing a multitude of economic time series, both at the US national and international levels. Utilizing the `fredr` package, we integrated six distinct datasets into one dataframe. These datatsets were:
...
The income and price elasticities of food are crucial factors in understanding why there's not much change in food spending despite changes in income. Income elasticity measures how much food demand shifts when income changes, while price elasticity assesses the impact of price changes on food demand.
...
In essence, these findings show that there's only a modest increase in food demand as income rises and a moderate decrease as food prices go up. Consequently, changes in income don't lead to significant shifts in food demand. 
...
We use ran trace plots for both models and we are interested in understanding whether the algorithm ran into any issues [@Alexander_2023]. Looking at the plots for both models, we do not encounter any out of the ordinary events.
