...
data1 <- pivot_longer(data, cols = -date, names_to = "variable", values_to = "value")
...
formatted_data[1:12,] |> 
  ...
  footnote(general = "This only shows quarterly data from 2007 to 2009. The actual data set consists of quarterly data
           from 2007 to 2022",
           threeparttable = TRUE)
```
